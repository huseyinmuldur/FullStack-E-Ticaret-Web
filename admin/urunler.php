   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="Ürün ismini girin" name="name">
         </div>
         <div class="inputBox">
            <span>Ürün Fiyatı (Zorunlu)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="Ürünün fiyatını girin" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="Ürünün detaylarını girin" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
      
      <input type="submit" value="Ürünü Ekle" class="btn" name="add_product">
   </form>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price"><span><?= $fetch_products['price']; ?></span>TL</div>
