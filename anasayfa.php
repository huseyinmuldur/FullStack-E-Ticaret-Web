   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <h3>ESKİ TELEFONLAR İÇİN</h3>
            <a href="magaza.php" class="btn">Şimdi Satın Al</a>
         </div>
      </div>
...
<section class="category">
   ...
   <h1 class="heading">KATEGORİLER</h1>
...
<section class="home-products">
   ...
   <h1 class="heading">En Son Yüklenen Ürünler</h1>
   ...
   <?php
     $select_products = $conn->prepare("SELECT * FROM `urunler` LIMIT 6"); 
